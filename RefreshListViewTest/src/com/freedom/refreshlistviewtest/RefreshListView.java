...
public class RefreshListView extends ListView implements OnScrollListener,
	...
	private void initHeadView(Context context) {
		...
		mImageView = (ImageView) mHeadView.findViewById(R.id.add_ImageView);
	...
	private void initLoadMoreView(Context context) {
		mFootView = LayoutInflater.from(context).inflate(R.layout.load_more,
				null);
	...
	private void updateLoadMoreViewState(int state) {
		...
		case ILoadMoreViewState.LMVS_LOADING:
			moreImageView = (ImageView)findViewById(R.id.more_ImageView);
			mLoadingView.setVisibility(View.VISIBLE);
			mLoadMoreTextView.setVisibility(View.GONE);
			moreImageView.clearAnimation();
			moreImageView.startAnimation(loadAnimation);
			break;
